...
INSERT INTO `make` (`id`, `code`, `name`) VALUES
(1, 'ACURA', 'Acura'),
(2, 'ALFA', 'Alfa Romeo'),
(3, 'AMC', 'AMC'),
...
INSERT INTO `model` (`id`, `make_id`, `code`, `name`) VALUES
...
insert into location(ID, postal_code, name)
values (1, 2500, 'Valby'),
       (2, 2600, 'Glostrup'),
       (3, 2605, 'Brøndby'),
       (4, 2610, 'Rødovre'),
       ...
       (10, 2640, 'Hedehusene'),
       (11, 2650, 'Hvidovre'),
       (12, 2660, 'Brøndby Strand'),
       (13, 2665, 'Vallensbæk Strand'),
       (14, 2670, 'Greve'),
       (15, 2680, 'Solrød Strand'),
       (16, 2690, 'Karlslunde'),
       (17, 2700, 'Brønshøj'),
       (18, 2720, 'Vanløse'),
       (19, 2730, 'Herlev'),
...
(3, 'indominus', NULL, 'password1', 'indominus@emailformat.com',3),
(4, 'inferno', NULL, 'password1', 'inferno@emailformat.com',4),
(5, 'invincible', NULL, 'password1', 'invincible@emailformat.com',5),
(6, 'lightspeed', NULL, 'password1', 'lightspeed@emailformat.com',6),
(7, 'madmax', NULL, 'password1', 'madmax@emailformat.com',7),
(8, 'matchbox', NULL, 'password1', 'matchbox@emailformat.com',8),
(9, 'optimusPhantomWarlock', 10, 'password1', 'opw@emailformat.com',9),
(10, 'dominator', NULL, 'password1', 'dominator@emailformat.com',10),
(11, 'ladybug', NULL, 'password1', 'ladybug@emailformat.com',11),
(12, 'plasticFantastic', NULL, 'password1', 'plasticfantastic@emailformat.com',12),
(13, 'clownshoe', NULL, 'password1', 'clownshoe@emailformat.com',13),
(14, 'thebrick', NULL, 'password1', 'thebrick@emailformat.com',14),
(15, 'terminator', NULL, 'password1', 'terminator@emailformat.com',15),
(16, 'saabaru', NULL, 'password1', 'saabaru@emailformat.com',16),
(17, 'breadvan', NULL, 'password1', 'breadvan@emailformat.com',17),
(18, 'rambo lambo', NULL, 'password1', 'rambolambo@emailformat.com',18),
(19, 'scooby', NULL, 'password1', 'voldamort@emailformat.com',19),
(20, 'bugeye', NULL, 'password1', 'bugeye@emailformat.com',20),
(21, 'godzilla', NULL, 'password1', 'godzilla@emailformat.com',21),
(22, 'goat', NULL, 'password1', 'goat@emailformat.com',22),
(23, 'voyager', NULL, 'password1', 'voyager@emailformat.com',23),
(24, 'phantom', NULL, 'password1', 'phantom@emailformat.com',4),
(25, 'fordor', NULL, 'password1', 'warlock@emailformat.com',5),
(26, 'garth', NULL, 'password1', 'garth@emailformat.com',6),
...
select * from orders join vehicle v on v.ID = orders.vehicle_ID join invoice i on orders.ID = i.order_id;
